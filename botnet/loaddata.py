    ...
    for line in file:
        ...
        try:
            ...
            if flag==0:
                ...
                elif label==1 and count2<6127:
                    Xdata.append([float(dur), protoDict[proto], int(Sport), int(Dport), Sip, Dip, int(totP), int(totB), stateDict[state]])
                    Ydata.append(label)
                    count2+=1

                elif count1>19999 and count2>6125:
                    #print("HI")
                    flag=1
